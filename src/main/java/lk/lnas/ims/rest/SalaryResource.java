...
import lk.lnas.ims.service.SalaryService;
...
public class SalaryResource {
    ...
    public ResponseEntity<Page<SalaryDTO>> paginateSalaries(
            @Parameter(hidden = true) @Filter Specification<Salary> spec, @ParameterObject Pageable pageable
    ) {
        log.debug("REST request to paginate Salary");
    ...
    public ResponseEntity<Long> createSalary(@RequestBody @Valid final SalaryDTO salaryDTO) {
        final Long createdId = service.create(salaryDTO);
